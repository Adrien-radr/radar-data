...
#define FXAA_FAST_PIXEL_OFFSET 0 // To prevent using textureGather*
...
//    vec3 hdrColor = fxaa(HDRFB, Exposure, gl_FragCoord.xy, Resolution, v_rgbNW, v_rgbNE, v_rgbSW, v_rgbSE, v_rgbM);
	...
	vec3 hdrColor = FxaaPixelShader(pos, dummy4, HDRFB, HDRFB, HDRFB, sampling, dummy4, dummy4, dummy4,
